...
exports.handler = function(event, context) {
    ...
    let intentParams = [
        
        {
            ...
            "fulfillmentLambda": {
                "region": "us-east-1",
                "accountId": "039569544879",
                "lambdaArn": "arn:aws:lambda:us-east-1:039569544879:function:textDownloadLink",
                "lambdaName": "textDownloadLink",
            },
            "fulfillmentActivity": {
                "type": "CodeHook",
                "codeHook": {
                    "messageVersion": "1.0",
                    "uri": "arn:aws:lambda:us-east-1:039569544879:function:textDownloadLink"
                }
            }, 
...
function ensureLambdaFunctionAccess(intent){
    if(intent.fulfillmentLambda){
        ...
        const params = {
            ...
            StatementId: `Lex-${intent.name}`+ "dce7bce6",
